...
def main():
    ...
    from codeloom import __version__ as current_version
    ...
    with open("codeloom/__init__.py", "r") as f:
        content = f.read()
    updated_content = re.sub(r'__version__ = ".+?"', f'__version__ = "{new_version}"', content)

    print("Updating codeloom/__init__.py with new version:")
    print(updated_content)
    if not dry_run:
        with open("codeloom/__init__.py", "w") as f:
            f.write(updated_content)

    git_commands = [
        ["git", "add", "codeloom/__init__.py"],
    ...
    print()
    print("Updating codeloom/__init__.py with new dev version:")
    ...
    # Remove codeloom/_version.py if it exists
    version_file = "codeloom/_version.py"
