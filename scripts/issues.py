...
Note: [A bot script](https://github.com/Codeloom-AI/codeloom/blob/main/scripts/issues.py) made these updates to the issue.
"""  # noqa

DUPLICATE_COMMENT = (
    """Thanks for trying codeloom and filing this issue.
...
CLOSE_FIXED_ENHANCEMENT_COMMENT = (
    ...
    """3 weeks. The requested feature should now be available in recent versions of codeloom.\n\n"""
...
CLOSE_FIXED_BUG_COMMENT = (
    ...
    """3 weeks. This issue should be resolved in recent versions of codeloom.\n\n"""
