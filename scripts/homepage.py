...
# Badge tooltip texts
GITHUB_STARS_TOOLTIP = "Total number of GitHub stars the Codeloom project has received"
PYPI_DOWNLOADS_TOOLTIP = "Total number of installations via pip from PyPI"
TOKENS_WEEKLY_TOOLTIP = "Number of tokens processed weekly by Codeloom users"
OPENROUTER_TOOLTIP = "Codeloom's ranking among applications on the OpenRouter platform"
SINGULARITY_TOOLTIP = "Percentage of the new code in Codeloom's last release written by Codeloom itself"

# Cache settings
CACHE_DIR = os.path.expanduser("~/.cache/codeloom-badges")
...
def get_downloads_from_bigquery(credentials_path=None, package_name="codeloom-chat"):
    """
...
def get_total_downloads(
    api_key=None, package_name="codeloom-chat", use_bigquery=False, credentials_path=None
):
    """
...
def get_github_stars(repo="paul-gauthier/codeloom"):
    """
...
def get_latest_release_codeloom_percentage():
    """
    Get the percentage of code written by Codeloom in the LATEST release
    ...
    try:
        ...
        if latest_release:
            percentage = latest_release.get("codeloom_percentage", 0)
...
def generate_badges_md(downloads, stars, codeloom_percentage):
    """
    ...
    # Round codeloom percentage to whole number
    codeloom_percent_rounded = round(codeloom_percentage)

    markdown = f"""  <a href="https://github.com/Codeloom-AI/codeloom/stargazers"><img alt="GitHub Stars" title="{GITHUB_STARS_TOOLTIP}"
src="https://img.shields.io/github/stars/Codeloom-AI/codeloom?style=flat-square&logo=github&color=f1c40f&labelColor=555555"/></a>
  <a href="https://pypi.org/project/codeloom-chat/"><img alt="PyPI Downloads" title="{PYPI_DOWNLOADS_TOOLTIP}"
...
src="https://img.shields.io/badge/🏆%20OpenRouter-Top%2020-9b59b6?style=flat-square&labelColor=555555"/></a>
  <a href="https://codeloom.chat/HISTORY.html"><img alt="Singularity" title="{SINGULARITY_TOOLTIP}"
src="https://img.shields.io/badge/🔄%20Singularity-{codeloom_percent_rounded}%25-e74c3c?style=flat-square&labelColor=555555"/></a>"""  # noqa
...
def get_badges_md():
    ...
    total_downloads = get_total_downloads(api_key, "codeloom-chat", use_bigquery, credentials_path)

    # Get GitHub stars for the default repo
    stars = get_github_stars("paul-gauthier/codeloom")

    # Get Codeloom contribution percentage in latest release
    percentage, _ = get_latest_release_codeloom_percentage()
...
def get_badges_html():
    ...
    codeloom_percent_rounded = round(percentage)

    # Generate HTML badges
    html = f"""<a href="https://github.com/Codeloom-AI/codeloom" class="github-badge badge-stars" title="{GITHUB_STARS_TOOLTIP}">
    <span class="badge-label">⭐ GitHub Stars</span>
    <span class="badge-value">{stars_formatted}</span>
</a>
<a href="https://pypi.org/project/codeloom-chat/" class="github-badge badge-installs" title="{PYPI_DOWNLOADS_TOOLTIP}">
...
<a href="/HISTORY.html" class="github-badge badge-coded" title="{SINGULARITY_TOOLTIP}">
    ...
    <span class="badge-value">{codeloom_percent_rounded}%</span>
</a>"""  # noqa
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Get total downloads and GitHub stars for codeloom")
    parser.add_argument(
        "--api-key",
        help=(
    ...
    parser.add_argument(
        "--package", default="codeloom-chat", help="Package name (default: codeloom-chat)"
    )
    parser.add_argument(
        "--github-repo",
        default="paul-gauthier/codeloom",
        help="GitHub repository (default: paul-gauthier/codeloom)",
    )
    ...
    # Get Codeloom contribution percentage in latest release
    percentage, version = get_latest_release_codeloom_percentage()
    print(f"Codeloom wrote {percentage:.2f}% of code in the LATEST release ({version})")
