...
from codeloom.help import Help, fname_to_url
...
class TestHelp(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        codeloom.coders.HelpCoder.run = help_coder_run

        def run_help_command():
            try:
                commands.cmd_help("hi")
            except codeloom.commands.SwitchCoder:
                pass
            else:
    ...
    def test_ask_without_mock(self):
        ...
        self.assertIn("codeloom", result.lower())
    ...
    def test_fname_to_url_unix(self):
        ...
        self.assertEqual(fname_to_url("website/docs/index.md"), "https://codeloom.chat/docs")
        self.assertEqual(
            fname_to_url("website/docs/usage.md"), "https://codeloom.chat/docs/usage.html"
        )
        self.assertEqual(fname_to_url("website/_includes/header.md"), "")

        # Test absolute Unix-style paths
        self.assertEqual(
            fname_to_url("/home/user/project/website/docs/index.md"), "https://codeloom.chat/docs"
        )
        self.assertEqual(
            fname_to_url("/home/user/project/website/docs/usage.md"),
            "https://codeloom.chat/docs/usage.html",
        )
    ...
    def test_fname_to_url_windows(self):
        ...
        self.assertEqual(fname_to_url(r"website\docs\index.md"), "https://codeloom.chat/docs")
        self.assertEqual(
            fname_to_url(r"website\docs\usage.md"), "https://codeloom.chat/docs/usage.html"
        )
        self.assertEqual(fname_to_url(r"website\_includes\header.md"), "")

        # Test absolute Windows-style paths
        self.assertEqual(
            fname_to_url(r"C:\Users\user\project\website\docs\index.md"), "https://codeloom.chat/docs"
        )
        self.assertEqual(
