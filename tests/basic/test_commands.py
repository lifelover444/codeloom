...
from codeloom.utils import ChdirTemporaryDirectory, GitTemporaryDirectory, make_repo
...
class TestCommands(TestCase):
    ...
    def test_cmd_add_bad_glob(self):
        # https://github.com/Codeloom-AI/codeloom/issues/293
    ...
    def test_cmd_add_from_subdir_again(self):
        with GitTemporaryDirectory():
            ...
            # https://github.com/Codeloom-AI/codeloom/issues/201
    ...
    def test_cmd_add_from_outside_root(self):
        with ChdirTemporaryDirectory() as tmp_dname:
            ...
            # https://github.com/Codeloom-AI/codeloom/issues/178
    ...
    def test_cmd_undo_with_dirty_files_not_in_last_commit(self):
        with GitTemporaryDirectory() as repo_dir:
            ...
            coder.codeloom_commit_hashes.add(last_commit_hash)
    ...
    def test_cmd_add_codeloomignored_file(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
    ...
    def test_cmd_model_preserves_explicit_edit_format(self):
        ...
        with mock.patch("codeloom.models.sanity_check_models"):
    ...
    def test_cmd_ask(self):
        ...
        with mock.patch("codeloom.coders.Coder.run") as mock_run:
