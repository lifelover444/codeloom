...
class TestModels(unittest.TestCase):
    def setUp(self):
        ...
        from codeloom.models import MODEL_SETTINGS
    ...
    @patch("codeloom.models.check_for_dependencies")
    ...
    @patch("codeloom.models.check_pip_install_extra")
    def test_check_for_dependencies_bedrock(self, mock_check_pip):
        ...
        from codeloom.models import check_for_dependencies
    ...
    def test_codeloom_extra_model_settings(self):
        import tempfile
    ...
    @patch("codeloom.models.litellm.completion")
