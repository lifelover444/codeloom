...
from codeloom.io import AutoCompleter, ConfirmGroup, InputOutput
...
class TestInputOutput(unittest.TestCase):
    ...
    def test_get_input_is_a_directory_error(self, mock_input):
        ...
        with patch("codeloom.io.open", side_effect=IsADirectoryError):
...
class TestInputOutputMultilineMode(unittest.TestCase):
    ...
    def test_ensure_hash_prefix(self):
        ...
        from codeloom.io import ensure_hash_prefix
...
@patch("codeloom.io.is_dumb_terminal", return_value=False)
