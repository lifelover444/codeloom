...
from codeloom.models import ModelInfoManager
...
def test_model_info_manager_uses_openrouter_manager(monkeypatch):
    ...
    monkeypatch.setattr("codeloom.models.litellm.get_model_info", lambda *a, **k: {})
    ...
    monkeypatch.setattr(
        "codeloom.models.OpenRouterModelManager.get_model_info",
