...
from codeloom.coders.base_coder import FinishReasonLength, UnknownEditFormat
...
from codeloom.sendchat import sanity_check_messages
...
"""
    ...
    def test_skip_codeloomignored_files(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
            ...
            aignore = Path(".codeloomignore")
            aignore.write_text(f"{fname1}\n{fname2}\ndir\n")
            repo = GitRepo(
                io,
                fnames,
                None,
                codeloom_ignore_file=str(aignore),
            )
...
This command will print 'Hello, World!' to the console."""
    ...
    def test_normalize_language(self):
        ...
        with patch("codeloom.coders.base_coder.Locale", None):
        ...
        with patch("codeloom.coders.base_coder.Locale", mock_babel_locale):
        ...
        with patch("codeloom.coders.base_coder.Locale", mock_babel_locale_error):
    ...
    def test_architect_coder_auto_accept_true(self):
        with GitTemporaryDirectory():
            ...
            with patch("codeloom.coders.architect_coder.AskCoder.__init__", return_value=None):
                from codeloom.coders.architect_coder import ArchitectCoder
                ...
                with patch("codeloom.coders.architect_coder.Coder.create", return_value=mock_editor):
