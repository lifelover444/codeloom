...
from codeloom.dump import dump  # noqa
...
class TestDeprecated(TestCase):
    ...
    @patch("codeloom.io.InputOutput.tool_warning")
    ...
    def test_deprecated_args_show_warnings(self, mock_offer_url, mock_tool_warning):
        ...
        for flag in deprecated_flags:
            ...
            with patch("codeloom.models.Model"), self.subTest(flag=flag):
                main(
    ...
    def test_model_alias_in_warning(self, mock_offer_url, mock_tool_warning):
        ...
        with patch("codeloom.models.MODEL_ALIASES", {"gpt4": "gpt-4-0613"}):
            with patch("codeloom.models.Model"):
                main(
