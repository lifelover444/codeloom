...
from codeloom import models, prompts, voice
from codeloom.editor import pipe_editor
from codeloom.format_settings import format_settings
from codeloom.help import Help, install_help_extra
from codeloom.io import CommandCompletionException
from codeloom.llm import litellm
from codeloom.repo import ANY_GIT_ERROR
from codeloom.run_cmd import run_cmd
from codeloom.scrape import Scraper, install_playwright
from codeloom.utils import is_image_file
...
class Commands:
    ...
    def cmd_chat_mode(self, args):
        ...
        show_formats = OrderedDict(
            [
                ("help", "Get help about using codeloom (usage, config, troubleshoot)."),
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by codeloom"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.codeloom_commit_hashes:
            self.io.tool_error("The last commit was not made by codeloom in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so codeloom can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to codeloomignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use codeloom.")

    def cmd_help(self, args):
        "Ask questions about codeloom"
        ...
        from codeloom.coders.base_coder import Coder
        ...
        user_msg += """
# Announcement lines from when this session of codeloom was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from codeloom.report import report_github_issue
