...
from codeloom.models import model_info_manager
...
class Analytics:
    ...
    def get_data_file_path(self):
        try:
            data_file = branding.user_data_path(branding.ANALYTICS_FILE)
    ...
    def posthog_error(self):
        ...
        # https://github.com/Codeloom-AI/codeloom/issues/2532
        self.ph = None
