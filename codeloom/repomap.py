...
from codeloom.dump import dump
from codeloom.special import filter_important_files
from codeloom.waiting import Spinner
...
class RepoMap:
    TAGS_CACHE_DIR = branding.tags_cache_dir(CACHE_VERSION)
