...
from codeloom import __version__, urls, utils
from codeloom.dump import dump  # noqa: F401

codeloom_user_agent = f"Codeloom/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["codeloom-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_playwright(self, url):
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                user_agent = user_agent.replace("headless", "")
                user_agent += " " + codeloom_user_agent
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({codeloom_user_agent})"}
        try:
            with httpx.Client(
